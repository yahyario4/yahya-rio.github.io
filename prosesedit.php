...
<head>
 ...
 <body>
          <h2 align="center"><blink>Edit Data </blink></h2>
		  <table>
		  <tr>
...
<?php
		...
		if($ganti =='YA')
		 ...
		 //query SQL untuk insert data 
		  $query ="Update bengkeljaya  SET no_faktur='$no_faktur',nama_customer='$nama_customer',noplat='$plat',tanggal='$tanggal',biaya_servis='$biaya_servis',biaya_sukucadang='$biaya_sukucadang',biaya_gantioli='$bg',total='$tb' WHERE no_faktur='".$no_faktur."'";
